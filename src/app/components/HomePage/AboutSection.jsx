...
function Counter({ end = 0, suffix = "", prefix = "" }) {
...
export default function AboutSection() {
  const stats = [
    ...
    },
    {
      ...
      suffix: " +",
      text: "Countries Served - Connecting continents through seamless logistics networks",
    },
  ];
    ...
    <section className="py-24 bg-white dark:bg-zinc-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-start">
          ...
          >
            <div className="relative w-full h-[440px] overflow-hidden shadow-lg bg-gray-100 rounded-lg">
              <img
          ...
          >
            <motion.h2 variants={fadeUp} className="title text-primary">
              About Us
            </motion.h2>

            <motion.h3 variants={fadeUp} className="title font-medium text-black leading-tight">
